...
import { fetchPayloadCatalogue } from '../services/payloadApi';
const DEFAULT_CONTENT = {
    id: "catalogue",
    title: "Catalogue",
    description: "Découvrez nos catalogues complets de produits et services adaptés à vos besoins professionnels.\n\nConsultez-les régulièrement pour rester à jour.",
    documents: [
        {
