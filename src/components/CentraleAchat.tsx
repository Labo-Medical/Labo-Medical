...
import { fetchPayloadCentraleAchats, type CentraleAchatsPayload } from '../services/payloadApi';

const DEFAULT_CONTENT: CentraleAchatsPayload = {
  id: "centraleachat",
  title: "Centrale d'achats",
  description:
    "LES LABORATOIRES ZEROUAL est une centrale d’achats spécialisée dans les industries médicales qui sont présentes en Afrique.\n\n" +
...
export default function CentraleAchats() {
  const [content, setContent] = useState<CentraleAchatsPayload>(DEFAULT_CONTENT);
