...
import { fetchPayloadLabKawassimPage, type LabKawassimPageData } from "../services/payloadApi";

const fallbackData: LabKawassimPageData = {
  doctor: {
  ...
  mapEmbedUrl:
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1001.1453528905728!2d-5.8576189329771955!3d35.765846272560026!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd0b87cbd2eb0c01%3A0xf6b13ada8a580187!2sLaboratoire%20Zeroual%20Kawassim!5e1!3m2!1sfr!2sma!4v1749252246161!5m2!1sfr!2sma",
};

export default function LaboratoireKawassimPage() {
  const [data, setData] = useState<LabKawassimPageData>(fallbackData);
    ...
    >
      ...
      <section style={{ padding: "1.5rem 2rem" }} className="lab-map">
        ...
        <iframe
          ...
          allowFullScreen
          loading="lazy"
          title="Localisation du laboratoire Kawassim"
