...
import { fetchPayloadLabSouaniPage } from "../services/payloadApi";
const fallbackData = {
    doctor: {
    ...
    mapEmbedUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3254.0748040818303!2d-5.826470888629062!3d35.77011157244426!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd0b878c75ed821b%3A0x1bf08c0b020f7d74!2sLaboratoire%20Zeroual%20Souani!5e1!3m2!1sfr!2sma!4v1750166666255!5m2!1sfr!2sma",
};
                    ...
                    padding: "0.5rem 1rem",
                            ...
                            boxShadow: "0 8px 16px rgba(0, 0, 0, 0.08)",
                                    ...
                                    height: "100%",
                                        ...
                                        objectFit: "cover",
                                        borderRadius: "16px",
                                    } }) }, data.slides[index].url) }) })] }), _jsxs("section", { style: { padding: "1.5rem 2rem" }, className: "lab-map", children: [_jsx("h2", { style: { marginBottom: "1rem", color: "#800000", fontSize: "1.3rem" }, children: "Localisation" }), _jsx("iframe", { src: data.mapEmbedUrl, width: "100%", height: "300", style: { border: 0, borderRadius: "12px", boxShadow: "0 4px 12px rgba(0,0,0,0.06)" }, allowFullScreen: true, loading: "lazy", title: "Localisation du laboratoire Souani", referrerPolicy: "no-referrer-when-downgrade" })] })] }));
}
