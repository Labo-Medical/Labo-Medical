...
import { fetchPayloadCharfPage } from "../services/payloadApi";
const fallbackData = {
    doctor: {
    ...
    mapEmbedUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3254.1759942009608!2d-5.7900737499999995!3d35.7676384!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd0b8099a928087b%3A0x2d7fde41e134fdf8!2sCharf%2C%20Tanger!5e1!3m2!1sfr!2sma!4v1752662883489!5m2!1sfr!2sma",
};
                    ...
                    padding: "0.5rem 1rem",
                            ...
                            boxShadow: "0 8px 16px rgba(0, 0, 0, 0.08)",
                                    ...
                                    height: "100%",
                                        ...
                                        objectFit: "cover",
                                        borderRadius: "16px",
                                    } }) }, data.slides[index].url) }) })] }), _jsxs("section", { style: { padding: "1.5rem 2rem" }, className: "lab-map", children: [_jsx("h2", { style: { marginBottom: "1rem", color: "#800000", fontSize: "1.3rem" }, children: "Localisation" }), _jsx("iframe", { src: data.mapEmbedUrl, width: "100%", height: "300", style: { border: 0, borderRadius: "12px", boxShadow: "0 4px 12px rgba(0,0,0,0.06)" }, allowFullScreen: true, loading: "lazy", referrerPolicy: "no-referrer-when-downgrade", title: "Localisation du laboratoire Charf" })] })] }));
}
