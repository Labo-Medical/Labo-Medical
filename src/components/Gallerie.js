...
export default function Galerie() {
    ...
    return (_jsx("section", { className: "gallerie-section", children: _jsxs("div", { style: { maxWidth: 1200, margin: "auto", padding: 16 }, children: [_jsx("h2", { style: { color: "#831616" }, children: "GALLERIE" }), _jsx(PhotoAlbum, { layout: "masonry", photos: visiblePhotos, spacing: 10, padding: 5, onClick: ({ index }) => setLightboxIndex(index) }), visibleCount < photos.length && (_jsx("div", { style: { textAlign: "center", marginTop: 20 }, children: _jsx("button", { onClick: () => setVisibleCount(photos.length), style: {
                            padding: "10px 20px",
                            fontSize: 16,
                            cursor: "pointer",
                            borderRadius: 5,
                            ...
                            color: "#fff",
                        }, children: "Voir plus" }) })), lightboxIndex !== null && (_jsx(Lightbox, { slides: slides, open: lightboxIndex !== null, index: lightboxIndex, close: () => setLightboxIndex(null) }))] }) }));
}
